...
#creates a Debian preseed based template
...
TEMPLATE_VERSION="$2" 
TEMPLATE_DISPLAY_NAME="Debian $TEMPLATE_VERSION (Jessie)"
TEMPLATE_DESCRIPTION="$TEMPLATE_DISPLAY_NAME"
TEMPLATE_LABEL=$1
TEMPLATE_ROOT=".tftp/boot/images/Debian-$TEMPLATE_VERSION"
...
TEMPLATE_BASE=$REPO_URL/$TEMPLATE_ROOT/debian-installer/amd64
...
addFileAsset "debian-install.ipxe" "/ipxe_config_install"

#add vmlinuz
addBinaryURLAsset 'linux' 'linux'

#add initrd.gz
addBinaryURLAsset 'initrd.gz' 'initrd.gz'

#add preseed file preseed.cfg
addFileAsset 'preseed.cfg' '/preseed.cfg'

# gpg keyring
addBinaryURLAsset 'debian-archive-keyring.gpg' 'debian-archive-keyring.gpg'
